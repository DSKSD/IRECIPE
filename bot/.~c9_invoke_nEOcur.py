...
specialTag = ['안주', '매콤', '달콤', '달달', '담백', '얼큰', '시원', '새콤', '야식', '간식', '간단','간단히', '가볍', '매운', '즉석',
...
def intentClassifier(sentence):
    ...
    NEGATIVE = ("바보", "멍청", "멍충", "ㅂㅅ", "닥쳐" ,"ㅅㅂ", "시발", "ㄷㅈㄹ", "뒤질래", "빠가", "ㅡㅡ", "ㅆㅃ", "존못",
                ...
                "에효", "에휴","노노","ㄴㄴ", "ㅗㅗ", "아니","아닌", "싫", "임마", "인마", "좌식","시러", "돌았", "도랏"
                ...
                "아는게 뭐야", "아는게 머야", "아는게뭐야", "아는게머야", "아는게 없어", "아는게없어", "아는겡버서", "얌마",
